...
func (client *ShopifyTestImpl) OAuthRequest(details Ctx, request OAuthRequest) (result OAuthResponse, err error) {
...
func (client *ShopifyTestImpl) RecurringApplicationChargeCreate(details Ctx, request RecurringApplicationCharge) (result RecurringApplicationCharge, err error) {
...
func (client *ShopifyTestImpl) RecurringApplicationChargeActivate(details Ctx, request RecurringApplicationCharge) (result RecurringApplicationCharge, err error) {
...
func (client *ShopifyTestImpl) ShopGet(details Ctx) (result Shop, err error) {
...
func (client *ShopifyTestImpl) WebhookCreate(details Ctx, request Webhook) (result Webhook, err error) {
...
func (client *ShopifyTestImpl) WebhookDelete(details Ctx, request Webhook) (err error) {
	delete(client.fakeCreateWebhookResponses, details.ShopName)
	return
}

func (client *ShopifyTestImpl) WebhookList(details Ctx, options WebHookRequestOptions) (result []Webhook, err error) {
...
func (client *ShopifyTestImpl) ProductList(details Ctx, options ProductRequestOptions) (result []Product, err error) {
...
func (client *ShopifyTestImpl) CollectList(details Ctx, options CollectRequestOptions) (result []Collect, err error) {
...
func (client *ShopifyTestImpl) RecurringApplicationChargeList(details Ctx, options RecurringApplicationChargeOptons) (result []RecurringApplicationCharge, err error) {
...
func (c *ShopifyTestImpl) ScriptTagCreate(details Ctx, scriptTag ScriptTag) (result ScriptTag, err error) {
